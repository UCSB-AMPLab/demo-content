Telar is built on [[iiif|IIIF]] (International Image Interoperability Framework), an open standard that makes it easy to deliver, view, and annotate high-resolution images on the web (see the [IIIF integration guide](https://telar.org/docs/iiif-integration/) in the Telar docs).
...
**This map** comes from the Huntington Library's [[iiif-manifest|IIIF collection]] and loads seamlessly in Telar.
